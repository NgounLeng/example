...
<meta charset="UTF-8" />
  ...
  <link rel="icon" href="https://png.pngtree.com/png-vector/20240531/ourmid/pngtree-colorful-bird-logo-design-illustration-png-image_12584961.png">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img class="size-8" src="https://png.pngtree.com/png-vector/20240531/ourmid/pngtree-colorful-bird-logo-design-illustration-png-image_12584961.png" alt="Your Company">
          </div>
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Download</a>
